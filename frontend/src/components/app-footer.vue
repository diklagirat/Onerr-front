        ...
        <footer class="main-footer main-layout">
            ...
            <div class="footer-right flex">
                <ul class="footer-social clean-list flex space-between align-center">
                    <li><svg class="icon" width="21" height="20" viewBox="0 0 21 20" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <li><svg class="icon" width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path
